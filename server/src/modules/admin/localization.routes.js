...
const LOCALIZATION_NAMESPACES = ['nav', 'admin', 'common', 'auth'];
const LOCALIZATION_OPERATION_TYPES = ['check_missing_keys', 'export_json', 'import_pack', 'compare_ru_en'];
...
export async function handleAdminLocalization(req, res) {
  sendJson(res, 200, {
    ...
    operation_types: LOCALIZATION_OPERATION_TYPES,
    guardrails: {
