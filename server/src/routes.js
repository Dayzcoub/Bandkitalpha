...
export function buildRoutes(env) {
  return [
    ...
    { method: 'GET', path: '/entities', limit: 'none', access: 'authed', handler: handleListEntities },
    { method: 'POST', path: '/entities', limit: 'write.default', access: 'authed', handler: handleCreateEntity },
    { method: 'GET', path: '/entities/:entityId', limit: 'none', access: 'authed', handler: (req, res, p) => handleGetEntity(req, res, p[0]) },
    ...
    { method: 'GET', path: '/posts/:postId/comments', limit: 'none', access: 'authed', handler: (req, res, p) => handleListComments(req, res, p[0]) },
    ...
    { method: 'GET', path: '/entities/:entityId/posts', limit: 'none', access: 'authed', handler: (req, res, p) => handleListEntityPosts(req, res, p[0]) },
